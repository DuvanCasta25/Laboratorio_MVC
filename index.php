...
<body>
    <section id="home">
        <div class="contenido">
            ...
            <div class="presentacion">
                ...
                <h2>Soy <span>Duvan Jandeiro Castañeda Hueje<</span> Ingeniero de sistemas</h2>
    ...
    <section id="about">
        ...
        <div class="info_sobreMi">
            ...
            <h2>Soy, <span>Duvan Jandeiro Castañeda Hueje</span></h2>
            <h3>Slogan</h3>
    ...
    <section id="contactus">
        ...
        <form action="">
            <div class="inputBox">
                ...
                <div class="input">
                    ...
                    <input type="number" placeholder="(+57) 321 231 5146">
                </div>
            </div>
            <div class="inputBox">
                <div class="input">
        ...
        <div class="contact-container">
            ...
            <div class="contact-card">
                ...
                <span class="contact-card-data">duvanch@gmail.com</span>
            </div>
